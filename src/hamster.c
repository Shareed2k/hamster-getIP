...
void hamster_getIP(struct mg_connection *conn, const struct mg_request_info *ri, void *user_data);
...
int main(int argc, char *argv[])
{
	...
	mg_bind_to_uri(mongoose_ctx, "/getIP.html", &hamster_getIP, myprox);
